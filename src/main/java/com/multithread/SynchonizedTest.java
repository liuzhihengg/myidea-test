...
public class SynchonizedTest {
    private static final int THREADS = 100; // 根据你的系统性能调整线程数
    private static final int OPERATIONS = 10000000; // 每种操作的次数
...
//    private static final Map<Integer,Integer> map = Collections.synchronizedMap(new HashMap<>());
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        double qps = (OPERATIONS) / seconds; // 四种操作各一次，总共执行了4 * OPERATIONS次操作
