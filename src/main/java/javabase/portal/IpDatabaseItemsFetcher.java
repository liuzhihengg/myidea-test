...
public class IpDatabaseItemsFetcher {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(JsonUtil.toJson(fetch(APP_CODE, ENV_NAME, "ip")));
    }
    ...
    public static List<JsonNode> fetch(String appCode, String envName) throws Exception {
        return fetch(appCode, envName, "ip");
    }

    public static List<JsonNode> fetch(String appCode, String envName, String content) throws Exception {
        String url = URL
        ...
        JsonNode ipList = root.path("data").path("rely").path("params").path("whitelist").path(content);
        if (!ipList.isArray()) {
